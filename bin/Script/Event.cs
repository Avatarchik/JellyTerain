...
namespace UnityEngine
{
	...
	public sealed class Event
	{
		...
		public bool shift
		{
			get
			{
				return (modifiers & EventModifiers.Shift) != EventModifiers.None;
			}
			set
			{
				if (!value)
		...
		public bool control
		{
			get
			{
				return (modifiers & EventModifiers.Control) != EventModifiers.None;
			}
			set
			{
				if (!value)
		...
		public bool alt
		{
			get
			{
				return (modifiers & EventModifiers.Alt) != EventModifiers.None;
			}
			set
			{
				if (!value)
		...
		public bool command
		{
			get
			{
				return (modifiers & EventModifiers.Command) != EventModifiers.None;
			}
			set
			{
				if (!value)
		...
		public bool capsLock
		{
			get
			{
				return (modifiers & EventModifiers.CapsLock) != EventModifiers.None;
			}
			set
			{
				if (!value)
		...
		public bool numeric
		{
			get
			{
				return (modifiers & EventModifiers.Numeric) != EventModifiers.None;
			}
			set
			{
				if (!value)
