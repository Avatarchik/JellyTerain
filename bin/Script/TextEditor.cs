...
namespace UnityEngine
{
	public class TextEditor
	{
		...
		public void Copy()
		{
			...
			{
				string text2 = GUIUtility.systemCopyBuffer = ((cursorIndex >= selectIndex) ? this.text.Substring(selectIndex, cursorIndex - selectIndex) : this.text.Substring(cursorIndex, selectIndex - cursorIndex));
			}
		}
