	...
	public class SourceSwitch : Switch
	{
		...
		public bool ShouldTrace(TraceEventType eventType)
		{
			...
			case TraceEventType.Critical:
				return (Level & SourceLevels.Critical) != SourceLevels.Off;
			case TraceEventType.Error:
				return (Level & SourceLevels.Error) != SourceLevels.Off;
			case TraceEventType.Warning:
				return (Level & SourceLevels.Warning) != SourceLevels.Off;
			case TraceEventType.Information:
				return (Level & SourceLevels.Information) != SourceLevels.Off;
			case TraceEventType.Verbose:
				return (Level & SourceLevels.Verbose) != SourceLevels.Off;
			default:
				return (Level & SourceLevels.ActivityTracing) != SourceLevels.Off;
			}
		}
